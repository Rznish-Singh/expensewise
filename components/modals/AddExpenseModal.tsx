...
import { CATEGORY_META, type ExpenseCategory, type ExpenseInsert } from "@/types";
import { useExpenses } from "@/hooks/useExpenses";

interface Props {
  open: boolean;
  onClose: () => void;
  onSuccess?: (expense: ExpenseInsert) => void;
  defaultDate?: string;
}
...
export function AddExpenseModal({ open, onClose, onSuccess, defaultDate }: Props) {
  ...
  function handleClose() {
    ...
    setCategory("food"); setType("expense");
    ...
    >
      <div className="bg-white rounded-2xl w-full max-w-md shadow-2xl animate-fade-in">
        ...
        <div className="flex items-center justify-between px-6 py-5 border-b border-black/[0.07]">
          <h2 className="font-serif text-xl font-light">Add Expense</h2>
